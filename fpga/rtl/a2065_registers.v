...
module a2065_registers #(
    ...
    assign regs_nrdy = BRIDGE_LOCAL ? 1'b0 : (sel_chipreg || (state != ST_IDLE));
                ...
                if (sel_chipreg) begin
                    if (cpu_addr[1:0] == 2'b10) begin
                        ...
                        if (cpu_rw) begin
                            ...
                            7'd0: begin
                                csr[0] &= ~16'h0040;
                                csr[0] |= cpu_data_in & 16'h0040;
                                csr[0] |= cpu_data_in & (16'h0001 | 16'h0002 | 16'h0004 | 16'h0008);
                                csr[0] &= ~(cpu_data_in & (16'h0100 | 16'h0200 | 16'h0400 |
                                                            16'h0800 | 16'h1000 | 16'h2000 | 16'h4000));
                                csr[0] &= ~16'h8000;
                                if ((cpu_data_in & 16'h0004) && (~csr[0] & 16'h0004)) begin
                                    csr[0] <= 16'h0004;
                                end
                            end
