...
> it has only the on-board NIC. This project runs a **custom-built MiSTer kernel with USB NIC support
> compiled in** (CDC-ECM / ASIX / RTL8152 etc.), which is what enumerates the USB adapter as `eth1`.
